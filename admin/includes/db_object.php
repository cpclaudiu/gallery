...
class Db_object {
	...
	public static function find_all() {
		// This gives an error
		// return static::find_by_query("SELECT * FROM". static::$db_table ." ");  // wrong
		// can be fixed by replacing $this-> instead of static:: though not recomended
...
// Selects all by id from the table
